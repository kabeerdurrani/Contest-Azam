            ...
            <div class="profile-desc">
              <div class="profile-pic">
                ...
                <div class="profile-name">
                  <h5 class="mb-0 font-weight-normal">Decor Vista</h5>
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="addUser.php">Add User</a></li>
                 <li class="nav-item"> <a class="nav-link" href="userDetail.php">User Detail </a></li>
                ...
                <li class="nav-item"> <a class="nav-link" href="manage_reviews.php">View Customer Review</a></li>
                <li class="nav-item"> <a class="nav-link" href="manage_consultation.php">View Consulation</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="assets/images/faces/face15.jpg" alt="">
                    <p class="mb-0 d-none d-sm-block navbar-profile-name">Decor Vista</p>
